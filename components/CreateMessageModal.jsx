            ...
            <View style={{ backgroundColor: "white", padding: 10, height: "auto", width: "100%" }}>
                ...
                <View>
                    ...
                    <TextInput
                        ...
                        style={{ width: "100%", borderWidth: 1, paddingVertical: 5, paddingHorizontal: 10, borderColor: "#ccc", borderRadius: 6 }}
                ...
                <View style={{ width: "100%", display: 'flex', flexDirection: 'row', gap: 10, paddingTop: 10 }}>
                    <Text style={{ flex: 1, textAlign: 'center', paddingVertical: 10, backgroundColor: "#ef4444", color: "#fff", borderRadius: 6 }} onPress={clearData}>Cancel</Text>
